...
// <div classNameName="c1">
//                <div classNameName="ci">
...
//   <div   classNameName='ul1' style={{ width:'50%',marginLeft:'30%',backgroundColor:'palegreen'}}></div>
//   </div>
...
// <div classNameName='ab1'>


// <div classNameName='ab11' data-aos="flip-left">
//   <img src="assests/c1.jpg" alt="" style={{height:'45vh', margin:'4%',marginLeft:'20%'}} />
// </div>

// <div classNameName='ab12'>

// <h2 style={{marginLeft:'20%',marginTop:'3%'}}>Why Academics Works</h2>
// <div classNameName='ul1' style={{width:'43%',float:'left',marginLeft:'20%'}}></div>
...
// <div classNameName='ab11' data-aos="flip-right">
...
//  <div classNameName='bii'>
//   <div classNameName='b9'>


// <div classNameName='info1' data-aos='zoom-in'>
//   <img src="assests/sch11.png" classNameName='im1' alt="" />
...
//      secondary schools. And thirdly, the course will discuss the role of the teacher in the classNameroom </p>
// </div>
// <div classNameName='info2' data-aos='zoom-in'>
// <img src="assests/sch22.png" classNameName='im12' alt="" />
...
// </div>
// <div classNameName='info3' data-aos='zoom-in'>
// <img src="assests/sch33.png" classNameName='im13' alt="" />
...
// <h1 classNameName='head1' style={{marginLeft:'40%'}}>Our Teachers</h1>
// <div classNameName='ul1'></div>
...
//          <h3 classNameName='text-center'>Sarah Jhonson</h3>
//          <p classNameName='text-center'> Product Manager</p>
...
//          <h3 classNameName='text-center'>Walter White</h3>
//          <p classNameName='text-center'> Chief Executive Officer</p>
//          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, dolore.. Quam</p>
//        </div>
...
//          <h3 classNameName='text-center'> William Anderson</h3>
//          <p classNameName='text-center'> CTO</p>
//          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, dolore.. Quam</p>
//        </div>
...
//          <h3 classNameName='text-center'>Amanda Jepson</h3>
//          <p classNameName='text-center'> Accountant</p>
//          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, dolore.. Quam</p>
//        </div>
...
//          <h3 classNameName='text-center'>Brian Doe</h3>
//          <p classNameName='text-center'> Marketing</p>
//          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, dolore.. Quam</p>
//        </div>
...
//          <h3 classNameName='text-center'>Josepha Palas</h3>
//          <p classNameName='text-center'> Operation</p>
//          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, dolore.. Quam</p>
//        </div>
//        </div> 
...
//   <div data-aos='fade-up'  style={{marginTop:'3%' , marginLeft:'10%', float:'left', width:'20%'}}>
//     <img src="assests/c1.jpg" alt="" style={{ height:'40vh', width:'100%' , borderStyle:'groove',borderRadius:'50%'}} />
//     <h3 classNameName='text-center'>Sarah Johnson</h3>
//     <p classNameName='text-center'>Product Manager</p>
//     <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, dolore.. Quam</p>
//   </div>
...
const About = () => {
  ...
  return (
    <>
      ...
      <div className="about-section" style={{ backgroundColor: '#8082C4', height: '60vh', marginTop: '2%', width: '100%' }}>
        <div style={{ width: '40%', float: 'left' }}>
          <h2 style={{ marginLeft: '29%', marginTop: '10%', color: 'white' }}>About Our University</h2>
        ...
        <div style={{ width: '60%', float: 'left' }}>
          <p style={{ marginTop: '7%', marginRight: '15%', color: 'white' }}>
            To always remain inclusive and quality conscious, and with deep conviction that knowledge
            not only improves the quality of life, but leads to good character, to capitalize on our inherent
            advantages to generate skilled manpower for nation-building through excellent teaching,
            attracting talent, fostering creativity, research, and innovation.
          </p>

          <p style={{ marginTop: '5%', marginRight: '15%', color: 'white' }}>
            To provide a conducive atmosphere for creative thinking and impart deep disciplinary knowledge with
            interdisciplinary bandwidth to the learners in order to make them problem solvers, leaders, and entrepreneurs.
          </p>

          <p style={{ marginTop: '5%', marginRight: '15%', color: 'white' }}>
            To contribute effectively to the welfare of society, address local and global challenges while respecting
      ...
      <div className="ab1">
        <div className="ab11" data-aos="flip-left">
          <img src="assests/c1.jpg" alt="University Campus" style={{ height: '45vh', margin: '4%', marginLeft: '20%' }} />
        </div>

        <div className="ab12">
          <h2 style={{ marginLeft: '20%', marginTop: '3%' }}>Why Academics Works</h2>
          <div className="ul1" style={{ width: '43%', marginLeft: '20%' }}></div>
          <p style={{ marginLeft: '20%', marginRight: '15%', marginTop: '5%' }}>
          ...
          <p style={{ marginLeft: '20%', marginRight: '15%' }}>
            Recognize the procedure of conducting a needs analysis and the role of learning objectives in course design.
          </p>
          <p style={{ marginLeft: '20%', marginRight: '15%' }}>
            Motivating Students to Learn, Transformative Teaching, and Data Entry Tools and Techniques.
          </p>
        </div>
      </div>
      ...
      <div className="ab1">
        ...
        <div className="ab11" data-aos="flip-right">
          <img src="assests/c3.jpg" alt="Personalized Learning" style={{ height: '45vh', margin: '4%', marginLeft: '20%' }} />
        </div>
      </div>
      ...
      <div className="bii">
        <div className="b9">
          <div className="info1" data-aos="zoom-in">
            <img src="assests/sch11.png" className="im1" alt="Philosophy" />
            <h3 style={{ color: 'palegreen', marginLeft: '40%' }}>Our Philosophy</h3>
            <p style={{ marginLeft: '40%', color: 'rgb(151, 151, 151)' }}>
              The course will discuss the characteristics and learning styles of elementary, secondary, and adult learners.
            </p>
          </div>

          <div className="info2" data-aos="zoom-in">
            <img src="assests/sch22.png" className="im12" alt="Academic Principle" />
            <h3 style={{ color: 'palegreen', marginLeft: '20%' }}>Academic Principle</h3>
            <p style={{ marginLeft: '20%', color: 'rgb(151, 151, 151)' }}>
              Research on academic motivation focuses on explaining why students behave the way they do and how this
              affects learning and performance.
            </p>
          </div>

          <div className="info3" data-aos="zoom-in">
            <img src="assests/sch33.png" className="im13" alt="Key to Success" />
            <h3 style={{ color: 'palegreen', marginLeft: '20%' }}>Key to Success</h3>
            <p style={{ marginLeft: '20%', color: 'rgb(151, 151, 151)' }}>
              Success in life may be defined individually. Once you learn how to succeed, you can apply the same
              strategies to other areas of your life.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="Team" style={{ backgroundColor: 'aliceblue', height: '150vh', marginTop: '5%', width: '100%' }}>
        {[
          { name: 'Sarah Johnson', role: 'Product Manager', img: 'assests/c1.jpg' },
          { name: 'Walter White', role: 'CEO', img: 'assests/t2.jpeg' },
          { name: 'William Anderson', role: 'CTO', img: 'assests/t4.jpg' },
          { name: 'Amanda Jepson', role: 'Accountant', img: 'assests/t4.jpeg' },
          { name: 'Brian Doe', role: 'Marketing', img: 'assests/t5.jpeg' },
          { name: 'Josepha Palas', role: 'Operations', img: 'assests/t3.jpeg' },
        ].map((teacher, index) => (
          <div key={index} data-aos="fade-up" style={{ marginTop: '3%', marginLeft: '10%', float: 'left', width: '20%' }}>
            <img src={teacher.img} alt={teacher.name} style={{ height: '40vh', width: '100%', borderStyle: 'groove', borderRadius: '50%' }} />
            <h3 className="text-center">{teacher.name}</h3>
            <p className="text-center">{teacher.role}</p>
